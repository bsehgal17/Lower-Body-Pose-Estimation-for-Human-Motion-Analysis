...
def run_humaneva_assessment(
    ...
    """
    Run HumanEva assessment with configurable confidence filtering.
    ...
    # Create a wrapper function that includes the confidence parameters
    def data_loader_with_confidence(pred_pkl_path, pipeline_config, global_config):
    ...
    run_assessment(
        ...
        data_loader_func=data_loader_with_confidence,
