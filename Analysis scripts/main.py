...
from visualizer import (
    ...
    plot_pck_vs_metric  # Note the change here
)
...
def main():
    ...
    # --- Step 1: Collect ALL brightness data for the overall analysis ---
    all_brightness_data = []
    all_contrast_data = []  # New list to store contrast data
    video_files = []
    ...
    for video_file in video_files:
        ...
        contrast_per_frame = analyzer.get_contrast_data()  # Get contrast data
    ...
    # Calculate overall average contrast
    ...
    # Plot the overall brightness distribution
    ...
    # --- Step 2: Load PCK scores and calculate overall averages for the overall plot ---
    ...
    # Plot the overall relation between brightness and PCK scores
    timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
    ...
    pck_df['avg_contrast'] = None  # New column for average contrast
    ...
    # Clean and convert the new columns
    ...
    # Create a scatter plot for each PCK threshold vs. Average Brightness
    ...
    # Create a scatter plot for each PCK threshold vs. Average Contrast
    for pck_col in PCK_SCORE_COLUMNS:
        timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
