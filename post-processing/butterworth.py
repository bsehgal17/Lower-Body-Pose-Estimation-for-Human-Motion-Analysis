        ...
        if video_info:
            ...
            for keypoint_set_idx in range(
                ...
                for joint_idx in lower_body_joints:
                    ...
                    try:
                        x_filtered = butterworth_filter(
                            np.array(x_interpolated))
                        y_filtered = butterworth_filter(
                            np.array(y_interpolated))
                    ...
                    if (
                        ...
                        plot_filtering_effect(
                            ...
                            save_path=os.path.join(
                                plot_dir, f"x_coord_joint_{joint_idx}_butterworth.png"
                            ),
                        )
                        ...
                        plot_filtering_effect(
                            ...
                            save_path=os.path.join(
                                plot_dir, f"y_coord_joint_{joint_idx}_butterworth.png"
                            ),
                        )
